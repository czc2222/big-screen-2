...
export const Chart1 = () => {
  ...
  return (
    <div className="销量">
      <div className="sales">
        <Ratio todaySales="今日销售额" todayMoney={sales} weekRatioText="周同比" weekRatio={weekSalesRatio}/>

        <Ratio todaySales="今日毛利额" todayMoney={profit} weekRatioText="周同比" weekRatio={weekProfitRatio}/>
      </div>
